...
% error('Tracker not configured! Please edit the tracker_re3.m file.'); % Remove this line after proper configuration
...
tracker_command = generate_python_command('re3_vot_tracker', {'/home/re3-pytorch/tracker/'});

tracker_interpreter = 'python3.5';
